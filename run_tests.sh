...
function run_tests_all {
  ...
  if [ $with_coverage -eq 1 ]; then
    ...
    check_paths="accounting/*,customizations/*,thresholds/*,notifications/*,kili/*,registration/*,async/*,keystone_wrapper/*,resource_pricing/*,billing_app/*,project_billing/*,billing_app/*"
