...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'k2_raw_data.claimed'
        db.add_column(u'billing_app_k2_raw_data', 'claimed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'k2_raw_data.claimed'
        db.delete_column(u'billing_app_k2_raw_data', 'claimed')
